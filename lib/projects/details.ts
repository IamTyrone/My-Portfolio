...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  "18": {
    ...
    image: "/img/projects/fund-admin/sign-in.webp",
    tags: [
      "React",
      "TypeScript",
      "Supabase",
    ...
    team: "Small team, everything through pull request review",
    ...
    learnings: [
      "A financial write that is not atomic is a corruption bug waiting for a slow connection",
      "Duplicate detection should warn and let a human decide, not merge silently on a threshold",
      "Deriving reports from the ledger is what makes them defensible when someone queries a figure",
      "Returning nothing from a returns calculation beats returning a number nobody can defend",
      "In finance software the domain is the hard part, and the interface is the easy half",
    ],
    file: "fund-admin.md",
  },
  "19": {
