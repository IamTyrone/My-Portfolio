...
const registry: Record<string, TechIcon> = {
  ...
  tamagui: { icon: Component, color: "#7B5CFF" },
  ...
  typeorm: { icon: Database, color: "#FE0902" },
  ...
  dockerswarm: { icon: SiDocker, color: "#2496ED" },
  ...
  hashicorp: { icon: SiHashicorp, color: "#FFFFFF" },
  ...
  tanstackquery: { icon: Waypoints, color: "#FF4154" },
  zustand: { icon: Layers, color: "#FFB454" },
  weasyprint: { icon: SiPython, color: "#3776AB" },
  mcp: { icon: Waypoints, color: "#D97757" },
  ...
  hmacsha256: { icon: ShieldCheck, color: "#00E5A0" },
  rbac: { icon: KeyRound, color: "#FFB454" },
  ...
  paynow: { icon: CreditCard, color: "#1BA0E2" },
  paystack: { icon: CreditCard, color: "#00C3F7" },
  zbbank: { icon: PiggyBank, color: "#0A3D62" },
  zimrafdms: { icon: ScrollText, color: "#FFB454" },
  ifrs: { icon: ScrollText, color: "#00E5A0" },
  apikeys: { icon: KeyRound, color: "#FFB454" },
  opensource: { icon: Blocks, color: "#00E5A0" },
